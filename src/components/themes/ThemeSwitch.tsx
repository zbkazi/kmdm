...
const ThemeSwitch = () => {
  ...
  return (
    <div className="relative sm:ml-14">
      <button
        className=" rounded-full bg-pink-300 dark:bg-gray-800 justify-center p-2  shadow-lg shadow-neutral-400"
      ...
      {dropdownOpen && (
        <ul className="absolute right-0 bg-pink-300 dark:bg-gray-800 z-10 mt-2 p-2   rounded-full shadow-lg shadow-neutral-400 ">
          <li
          ...
          >
            <ComputerDesktopIcon className="w-6 h-6 hover:bg-purple-500" />
          </li>
        </ul>
      )}
    </div>
