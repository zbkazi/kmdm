...
export default function NotFound() {
  return (
    <div>
      ...
      >
        <div className="max-w-md mx-auto text-center bg-gray-200 dark:bg-slate-800 bg-opacity-90 p-8 rounded-lg shadow-lg">
          <div className="text-9xl font-bold text-indigo-600 mb-4">404</div>
          <h1 className="text-4xl font-bold text-gray-800 mb-6">
            Oops! Page Not Found
          </h1>
          <p className="text-lg text-gray-600 mb-8">
            The page youre looking for seems to have gone on a little adventure.
            Don not worry, well help you find your way back home.
          </p>
          <Link href="/">
